package com.mny.mojito.im.widget.airpanel;
...
public class AirPanelFrameLayout extends FrameLayout implements Contract.Panel {
    ...
    protected void onAttachedToWindow() {
        ...
        if (!isInEditMode()) {
            ViewComponentManager.FragmentContextWrapper context = (ViewComponentManager.FragmentContextWrapper) getContext();
            mDelegate.setup(context.fragment.getActivity());
        }
    }
