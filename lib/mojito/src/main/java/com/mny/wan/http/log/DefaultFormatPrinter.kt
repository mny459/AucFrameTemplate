...
import com.mny.wan.utils.CharacterHandler
...
class DefaultFormatPrinter : FormatPrinter {
    ...
    override fun printJsonResponse(chainMs: Long, isSuccessful: Boolean, code: Int, headers: String, contentType: MediaType?,
        ...
        bodyString = if (RequestInterceptor.isJson(contentType)) CharacterHandler.jsonFormat(bodyString) else if (RequestInterceptor.isXml(contentType)) CharacterHandler.xmlFormat(bodyString) else bodyString
