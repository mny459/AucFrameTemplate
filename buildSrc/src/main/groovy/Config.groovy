class Config {
    ...
    static depConfig = [
            ...
            feature_basic_app          : new DepConfig(true , true , ":feature:basic:app"),
            feature_basic_pkg          : new DepConfig(true , true , ":feature:basic:pkg"),
            feature_basic_export       : new DepConfig(true , true , ":feature:basic:export"),
